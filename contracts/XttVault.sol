...
contract XttVault is Ownable, Pausable {
    ...
    struct UserInfo {
        ...
        uint256 xttAtLastUserAction; // keeps track of xtt deposited at the last user action
        uint256 lastUserActionTime; // keeps track of the last user action time
    }

    IERC20 public immutable token; // Xtt token
    ...
    /**
     * @notice Constructor
     * @param _token: Xtt token contract
    ...
    /**
     * @notice Deposits funds into the Xtt Vault
     * @dev Only possible when contract not paused.
     * @param _amount: number of tokens to deposit (in XTT)
     */
    function deposit(uint256 _amount) external whenNotPaused notContract {
        ...
        user.xttAtLastUserAction = user.shares.mul(balanceOf()).div(totalShares);
    ...
    /**
     * @notice Reinvests XTT tokens into MasterChef
     * @dev Only possible when contract not paused.
     */
    ...
    /**
     * @notice Withdraw unexpected tokens sent to the Xtt Vault
     */
     ...
     * @return Expected reward to collect in XTT
     */
     ...
     * @return Returns total pending xtt rewards
     */
    ...
    /**
     * @notice Withdraws from funds from the Xtt Vault
